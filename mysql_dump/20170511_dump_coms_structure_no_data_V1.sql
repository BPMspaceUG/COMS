...
) ENGINE=InnoDB AUTO_INCREMENT=123717 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `coms_exam_event` (
  ...
  `coms_exam_id` bigint(20) NOT NULL,
  `coms_event_state_id` bigint(20) NOT NULL,
  ...
  KEY `coms_state_id_fk2_idx` (`coms_event_state_id`),
  ...
  CONSTRAINT `coms_state_id_fk2` FOREIGN KEY (`coms_event_state_id`) REFERENCES `state` (`state_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
) ENGINE=InnoDB AUTO_INCREMENT=876044 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `coms_participant_exam_event` (
  ...
  `coms_participation_state_id` bigint(20) DEFAULT NULL,
  ...
  KEY `coms_state_id_fk1_idx` (`coms_participation_state_id`),
  ...
  CONSTRAINT `coms_state_id_fk1` FOREIGN KEY (`coms_participation_state_id`) REFERENCES `state` (`state_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
) ENGINE=InnoDB AUTO_INCREMENT=17239804 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3924607 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=773534 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `coms_training_organisation_trainer` (
  ...
  CONSTRAINT `coms_training_organisationt_id_fk_3` FOREIGN KEY (`coms_training_organisation_id`) REFERENCES `coms_training_organisation` (`coms_training_organisation_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `state_rules` (
  ...
  KEY `state_id_FROM_fk1_idx` (`state_id_FROM`),
  KEY `state_id_TO_fk1_idx` (`state_id_TO`),
  CONSTRAINT `state_id_FROM_fk1` FOREIGN KEY (`state_id_FROM`) REFERENCES `state` (`state_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `state_id_TO_fk1` FOREIGN KEY (`state_id_TO`) REFERENCES `state` (`state_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2017-05-11  8:08:58
